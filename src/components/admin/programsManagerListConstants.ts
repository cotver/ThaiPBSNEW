...
export const PROGRAMS_LIST_COLUMNS: ProgramsListColumnDef[] = [
  ...
  { id: 'is_NEW', label: 'Recommended', sortKey: 'is_NEW' },
  ...
  { id: 'is_continue', label: 'Is Continue', sortKey: 'is_continue' },
  ...
  { id: 'companyProduce', label: 'Company Produce (Thai)', sortKey: 'companyProduce' },
  { id: 'companyProduceEn', label: 'Company Produce (English)', sortKey: 'companyProduceEn' },
  { id: 'producer', label: 'Producer (Thai)', sortKey: 'producer' },
  { id: 'producerEn', label: 'Producer (English)', sortKey: 'producerEn' },
  { id: 'director', label: 'Director (Thai)', sortKey: 'director' },
  { id: 'directorEn', label: 'Director (English)', sortKey: 'directorEn' },
  { id: 'artist', label: 'Artist (Thai)', sortKey: 'artist' },
  { id: 'artistEn', label: 'Artist (English)', sortKey: 'artistEn' },
  { id: 'writer', label: 'Writer (Thai)', sortKey: 'writer' },
  { id: 'writerEn', label: 'Writer (English)', sortKey: 'writerEn' },
...
export const PROGRAMS_FILTER_FIELDS: ProgramsFilterFieldDef[] = [
  ...
  { field: 'is_NEW', label: 'Recommended', type: 'checkbox' },
  ...
  { field: 'is_continue', label: 'Is Continue', type: 'checkbox' },
  ...
  { field: 'companyProduce', label: 'Company Produce (Thai)', type: 'text' },
  { field: 'companyProduceEn', label: 'Company Produce (English)', type: 'text' },
  { field: 'producer', label: 'Producer (Thai)', type: 'text' },
  { field: 'producerEn', label: 'Producer (English)', type: 'text' },
  { field: 'director', label: 'Director (Thai)', type: 'text' },
  { field: 'directorEn', label: 'Director (English)', type: 'text' },
  { field: 'artist', label: 'Artist (Thai)', type: 'text' },
  { field: 'artistEn', label: 'Artist (English)', type: 'text' },
  { field: 'writer', label: 'Writer (Thai)', type: 'text' },
  { field: 'writerEn', label: 'Writer (English)', type: 'text' },
