      ...
      {categories.map((category) => {
        ...
        return (
          <Link
            ...
            className="group relative aspect-video min-w-0 overflow-hidden rounded-[6px] border border-white/10 bg-[#111827] p-5 shadow-2xl shadow-black/40 transition duration-300 hover:-translate-y-1 hover:scale-[1.035] hover:border-white/50"
            ...
            {category.imageUrl && (
              <img
                ...
                className={`absolute inset-0 h-full w-full object-cover transition duration-300 ${
                  hasLoadedImage && !showVideo && !showOnlyName ? "opacity-100" : "opacity-0"
                }`}
                onLoad={() =>
