...
const styles: PrototypeStyle[] = ["style-1", "style-2", "style-3"];

export default function PrototypeComparisonPage() {
  return (
    <main className="prototype-hub">
      <header className="prototype-hub__header">
        <div><p>Thai PBS · Blog redesign study</p><h1>Three ways to<br/>tell the story.</h1></div>
        <p>Compare three complete, responsive directions. Each uses the same catalog data, routes and article structure.</p>
      </header>
