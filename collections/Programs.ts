...
export const Programs: CollectionConfig = {
      ...
      fields: [
        ...
        },
        {
          name: 'targetGroup',
          type: 'select',
          admin: { hidden: true, description: 'Target group' },
          options: [
            { label: 'อายุ 3-6 ปี', value: 'อายุ 3-6 ปี' },
            { label: 'อายุ 7-12 ปี', value: 'อายุ 7-12 ปี' },
            { label: 'อายุ 13-17 ปี', value: 'อายุ 13-17 ปี' },
            { label: 'อายุ 18-24 ปี', value: 'อายุ 18-24 ปี' },
            { label: 'อายุ 25-34 ปี', value: 'อายุ 25-34 ปี' },
            { label: 'อายุ 35-44 ปี', value: 'อายุ 35-44 ปี' },
            { label: 'อายุ 45-54 ปี', value: 'อายุ 45-54 ปี' },
            { label: 'อายุ 55 ปีขึ้นไป', value: 'อายุ 55 ปีขึ้นไป' },
          ],
        },
        {
          name: 'type',
        ...
        },
        {
          name: 'genre_sub',
          type: 'select',
          admin: { hidden: true, description: 'Sub-genre' },
          options: [
            { label: 'Agricultural&Local', value: 'Agricultural&Local' },
            { label: 'Arts&Culture', value: 'Arts&Culture' },
            { label: 'Knowledge&Education', value: 'Knowledge&Education' },
            { label: 'Entertainment', value: 'Entertainment' },
            { label: 'Lauguage', value: 'Lauguage' },
            { label: 'Inspiration&People', value: 'Inspiration&People' },
            { label: 'Nature&Environment', value: 'Nature&Environment' },
            { label: 'Biography', value: 'Biography' },
            { label: 'Pets&Animal', value: 'Pets&Animal' },
            { label: 'Travel&Adventure', value: 'Travel&Adventure' },
            { label: 'Health&Medical&Wellness', value: 'Health&Medical&Wellness' },
            { label: 'Political', value: 'Political' },
            { label: 'History', value: 'History' },
            { label: 'Crime', value: 'Crime' },
            { label: 'Science&Technology', value: 'Science&Technology' },
            { label: 'Senior Program', value: 'Senior Program' },
