...
export const Programs: CollectionConfig = {
      ...
      admin: {
        ...
        defaultColumns: ['programId', 'titleTh', 'titleEn', 'programContentType', 'producers', 'directors', 'artists', 'writers', 'createdAt', 'updatedAt'],
      ...
      fields: [
        ...
        },
        {
          ...
          relationTo: 'writers',
          hasMany: true,
          admin: { description: 'Writers' },
        },
        {
          name: 'producer',
          label: 'Producer (Thai) (Text)',
          type: 'text',
          admin: { description: 'Producer (Thai) (Text)' },
        },
        {
          name: 'producerEn',
          label: 'Producer (English) (Text)',
          type: 'text',
          admin: { description: 'Producer (English) (Text)' },
        },
        {
          name: 'director',
          label: 'Director (Thai) (Text)',
          type: 'text',
          admin: { description: 'Director (Thai) (Text)' },
        },
        {
          name: 'directorEn',
          label: 'Director (English) (Text)',
          type: 'text',
          admin: { description: 'Director (English) (Text)' },
        },
        {
          name: 'artist',
          label: 'Artist (Thai) (Text)',
          type: 'text',
          admin: { description: 'Artist (Thai) (Text)' },
        },
        {
          name: 'artistEn',
          label: 'Artist (English) (Text)',
          type: 'text',
          admin: { description: 'Artist (English) (Text)' },
        },
        {
          name: 'writer',
          label: 'Writer (Thai) (Text)',
          type: 'text',
          admin: { description: 'Writer (Thai) (Text)' },
        },
        {
          name: 'writerEn',
          label: 'Writer (English) (Text)',
          type: 'text',
          admin: { description: 'Writer (English) (Text)' },
        },
        {
          name: 'type',
          type: 'select',
