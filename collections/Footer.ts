...
export const Footer: CollectionConfig = {
      ...
      admin: {
        ...
        description: 'Footer with title and multiple items (link or content).',
      },
      access: {
        read: () => true,
      ...
      fields: [
        ...
        },
        {
          name: 'items',
          type: 'array',
          admin: { description: 'Footer items: each row is either a link or a content from the Content collection.' },
